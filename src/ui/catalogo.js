...
import { crearPaginador } from "./pagination.js";
...
const paginador = crearPaginador({
  contenedorEl: document.getElementById("pagination"),
  listaEl: catalogEl,
  porPagina: 8,
  onRenderPagina: (lista) => pintarTarjetas(lista),
});
...
export function renderCatalogo() {
  ...
  emptyStateEl.hidden = listaCompleta.length !== 0;
  paginador.render(listaCompleta);
}
